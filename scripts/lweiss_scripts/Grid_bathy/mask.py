...
path_fig = '/lus/home/CT1/c1601279/lweiss/PYTHON/FIGURES/Mask_tests/'
...
### SAVE
plt.savefig(path_fig + 'mask_iso_' + str(np.min(h).values) + '_swio2_cond_rx0_topo_02_2.png', dpi=300, bbox_inches='tight')
# plt.show()
plt.close()
