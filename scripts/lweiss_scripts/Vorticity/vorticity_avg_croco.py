...
# vort_mean.to_netcdf(path_fig + simu + f'/Vorticity/vorticity_mean_{simu}_{start_time}_{end_time}.nc')
...
### SAVE
plt.savefig(path_fig + simu + f'/Vorticity/vorticity_uv_mean_{simu}_{start_time}_{end_time}.png', dpi=300, bbox_inches='tight')
plt.close()
