...
get_result = copernicusmarine.get(
    dataset_id='METOFFICE-GLO-SST-L4-REP-OBS-SST', # ID du dataset sur https://data.marine.copernicus.eu/products
    dry_run=False, # Si True, affiche les fichiers à télécharger sans les télécharger
    filter="*2018/01/*", # Filtre les fichiers à télécharger
