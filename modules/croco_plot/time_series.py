    ...
    for name in names:
        ...
        for file in files:
            ...
            if 'Energies' in variables:
                ...
                ax.semilogy(time, mke, color=color, label=source, linestyle='--', alpha=0.1)
                ...
                ax.semilogy(time, eke, color=color, label=source, linestyle='--', alpha=0.1)
            ...
            if 'Anomalies' in variables:
                ax = axes_anomaly[0]
                sla = f.sla.data
                ax.plot(time, sla, color=color, label=source, linestyle='--', alpha=0.1)
                ...
                ax = axes_anomaly[1]
                ssa = f.ssa.data
                ax.plot(time, ssa, color=color, label=source, linestyle='--', alpha=0.1)
                ...
                ax = axes_anomaly[2]
                sta = f.sta.data
                ax.plot(time, sta, color=color, label=source, linestyle='--', alpha=0.1)
            ...
            if 'Fields' in variables:
                ...
                ax.plot(time, ssh, color=color, label=source, linestyle='--', alpha=0.1)
                ...
                ax.plot(time, sss, color=color, label=source, linestyle='--', alpha=0.1)
                ...
                ax.plot(time, sst, color=color, label=source, linestyle='--', alpha=0.1)
